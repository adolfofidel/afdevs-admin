    ...
    <div className="flex flex-col items-center justify-center p-8">
      {status === 'processing' && (
        <>
          ...
          <div className="flex items-center gap-2 text-white">
            ...
            <span className="text-lg">{message || 'Processing payment...'}</span>
          </div>
        </>
      )}
      ...
      {status === 'success' && (
        <>
          ...
          <span className="text-xl text-green-500 font-semibold">{message || 'Payment successful!'}</span>
        </>
      )}
      ...
      {status === 'error' && (
        <>
          ...
          <span className="text-xl text-red-500 font-semibold">{message || 'Payment failed'}</span>
        </>
      )}
    </div>
  )
