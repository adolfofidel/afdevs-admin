  ...
  return (
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
              <div className="flex min-h-0 flex-1 flex-col bg-brand-primary">
                      <div className="flex h-16 flex-shrink-0 items-center px-4 border-b border-brand-secondary">
                                <span className="text-xl font-bold text-white">AF DEVS Admin</span>span>
                      </div>div>
