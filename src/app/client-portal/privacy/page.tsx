        ...
        <div className="bg-gray-900 rounded-2xl p-8 shadow-xl border border-gray-800">
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            <section>
              ...
              <p className="text-gray-300">Recopilamos nombre, email, teléfono, información de facturación y datos de uso. NO almacenamos números de tarjeta completos ni CVV - los pagos son tokenizados por AZUL.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-3">2. Uso de la Información</h2>
              <p className="text-gray-300">Usamos su información para proporcionar servicios, procesar pagos, enviar notificaciones, responder consultas y prevenir fraudes.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-3">3. Compartir Información</h2>
              <p className="text-gray-300">No vendemos ni alquilamos su información. Solo compartimos datos con AZUL (pagos), Supabase (almacenamiento) y autoridades cuando lo requiera la ley.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-3">4. Seguridad</h2>
              <p className="text-gray-300">Implementamos encriptación TLS 1.3, certificados SSL, base de datos encriptada y acceso restringido.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-3">5. Sus Derechos</h2>
              <p className="text-gray-300">Puede acceder, rectificar, eliminar y exportar sus datos. Contacte support@afdevs.com para ejercer estos derechos.</p>
            </section>
